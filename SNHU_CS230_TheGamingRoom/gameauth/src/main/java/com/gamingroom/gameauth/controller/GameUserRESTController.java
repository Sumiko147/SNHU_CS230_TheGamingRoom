...
// DONE: Add path annotation for gameusers
// SM: "/gameusers" is a class level base path for all of the methods in this class.
@Path("/gameusers")
...
public class GameUserRESTController {
    ...
    // DONE: Add RolesAllowed annotation for USER based on BasicAuth Security Example 
    // SM: Only users with "USER" roles will be allowed access to this method.
    @RolesAllowed({"USER"})
    @GET
    @Path("/{id}")
    ...
    // DONE: Add RolesAllowed annotation for ADMIN based on BasicAuth Security Example 
    // SM: Only users with "ADMIN" roles will be allowed access to this method.
    @RolesAllowed("ADMIN")
    @POST
