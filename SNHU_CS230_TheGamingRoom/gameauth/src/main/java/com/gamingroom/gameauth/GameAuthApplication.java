...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// SM: GameUserRESTController class has one constructor that requires a Validator parameter
		...
		// SM: Created and configured a Jersey "Client" named "DemoRESTClient using JerseyClientBuilder. Registered the newly created client by instantiating a RESTClientController to handle incoming HTTP requests.
